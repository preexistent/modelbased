...
# Helper functions
    ...
    def choose_new_velocity_VO(self, goal_pose_x, goal_pose_y, agent_pose_x, agent_pose_y):
        #Find the nearest heading that is outside the VO
        self.desired_heading = atan2(goal_pose_y - agent_pose_y, goal_pose_x - agent_pose_x)
    ...
    def choose_new_velocity_RVO(self, goal_pose_x, goal_pose_y, agent_pose_x, agent_pose_y):
        rr = 2
        incr = 0.01
        self.desired_heading = atan2(goal_pose_y - agent_pose_y, goal_pose_x - agent_pose_x)
